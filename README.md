...
- En caso de tener problemas al subir el repositorio, enviar un comprimido del ejercicio al correo:
  flincang@pichincha.com
...
- Cargar productos a base de datos.
    - Crear endpoint que permita crear base de productos a partir de un servicio mock
        ...
        - Url mock tipo de petición
          POST: [Productos](https://253b6042-ec17-4ee8-8d7d-ea9d62805337.mock.pstmn.io/dummy-products)
    - Reglas de negocio:
